...
approaches \cite{todo} which classifies the available state-of-the-art solutions.
...
The development of PointNet \cite{todo} and its successor PointNet++ \cite{todo} give a unified
solution for various applications e.g. object and scene segmentation. Various
other solutions like GndNet \cite{todo}, PointPiller \cite{todo}, JCP \cite{todo}, SectorGSnet \cite{todo}
