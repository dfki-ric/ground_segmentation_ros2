...
\thanks{Funded via some awesome projects, Maybe we will publish the code}
}
...
%
The segmentation process is divided into two distinct phases.
...
as tentative ground until it is clarified the region growth step (Section~\ref{sec:region_growth})
