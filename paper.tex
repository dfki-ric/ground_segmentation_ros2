...
scene segmentation. Various other solutions like GndNet \cite{paigwar2020gndnet}, PointPillars \cite{lang2019pointpillars}, JCP \cite{todo}, SectorGSnet \cite{todo}
...
\begin{figure}
  ...
  corresponding eigen vectors (black) are shown. 
...
The experimentation was performed exclusively on datasets with real world point cloud data. No simulation data was used during the tests. We did not limit our 
experiementation merely to the SemanticKITTI
dataset. We selected a diverse set of datasets from urban and natural environments. Additonally, the datasets are based on different sensor configurations.
...
\subsection{GroundSeg3D Parameters}
