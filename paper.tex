...
individually. Such solutions are usually based on occupancy grids or elevation maps \cite{5650541,9558794}. Some
...
Given a point cloud within a grid cell, we calculate the eigenvalues of the covariance matrix of the points 
to assess their spatial distribution. Let $\lambda_1 > \lambda_2 > \lambda_3$ be their eigenvalues, we then compute the ratio:
%
...
\begin{figure}[tb]
  \centering
  \includegraphics[width=\linewidth,trim={0 0 0 1.5cm},clip]{figures/sloped terrain/arter_all.png}
...
\begin{table*}[tb]
  ...
  \toprule
   ...
   \cline{2-5} %\cline{6-9} %\cline{10-14}
   \qquad Sequence& 00 & 01 & 04 & 09 & 00 & 01 & 04 & 09 & 00  & 01 & 04 & 09\\
\midrule
...
These can cause the precision to drop below 94\% (Table~\ref{tab:comparison_09_non_downsampled}).
