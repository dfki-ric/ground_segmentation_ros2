...
\todo{Need a picture of the pipeline}
...
dataset and carefully selected a diverse set of datasets. The datasets are from urban and natural environments and all datasets use a different sensor configuration.
An ground segmentation solution must be able to perform well indepdently of the sensor configuration and without and parameter tuning. We also selected a handheld 
dataset to test the adaptability to a changing height of the sensor. Most existing solutions require a sensor height as a parameter with the assumption that the height
of the sensor is unchanged. This assumption does not hold in case of handheld or UAV based point cloud datasets.
...
collected only on the SemanticKITTI dataset. Visual analysis of ground segmentation results on other datasets was enough to compare the performance of the propose and
...
\begin{table}[h!]
  ...
  \hline
  \textbf{(maxX, minX, maxY, minY, maxZ, minZ)} & (500, -500, 500, -500, 500, -500) & Region of interest (in meters) of the point cloud in Euclidean space. \\ 
  \hline
  \textbf{downsample} & True & Toggle to downsample the point cloud to a user-defined resolution in meters. \\ 
  \hline
  ...
  \hline
  \textbf{startCellDistanceThreshold} & 80 & Maximum distance for selection of seed cells used as start cells for region growing. \\
  \hline
  \textbf{groundInlierThreshold} & 0.1 & Inlier threshold (in meters) for the plane model fitting to points in a grid cell. \\ 
  \hline
  \textbf{neighborsIndexThreshold} & 1 & Number of neighbors analyzed for neighborhood analysis. A value of 1 means that a single layer
                                         of neighbors (comprising of 24 neighbors) are evaluated. \\
  \hline
  \textbf{minPoints} & 5 & Minimum number of points assigned to a cell for plane model fitting. \\
  \hline
  \textbf{ransac\_iterations} & 1000 & Number of iterations of RANSAC for plane model fitting. \\
  \hline
  \end{tabular}%
  }
...
Our solution is independent of the sensor height or sensor type but most of the other state-of-the-art solutions depend on them. 
...
\begin{table}[h!]
  ...
  \hline
  \textbf{KITTI \cite{todo}} & Urban & Velodyne HDL-64E & 2013 & Car & 1.723 \\ 
  \hline
  \textbf{UrbanNav \cite{todo}} & Urban & Velodyne HDL-32E & 2021 & Car & 1.832 \\ 
  \hline
  ...
  \hline
  \textbf{RELLIS-3D \cite{todo}} & Natural & Velodyne VLP-32C & 2022 & Mobile Robot &  \\
  \hline
  \end{tabular}%
  }
  \label{tab:phase_behavior}
...
\subsubsection{RELLIES-3 \cite{todo}}
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{urban_nav_all.png}
  \caption{UrbanNav: UrbanNav Hong Kong Tunnel}
  \label{fig:urban_nav_all}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{nierendorf_final.png}
  \caption{DOALS: Nierendorf}
  \label{fig:nierendorf_final}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{bg_all.png}
  \caption{BotanicGarden: ?}
  \label{fig:bg_all}
\end{figure}

\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{r3d_all.png}
  \caption{RELLIES-3D: ?}
  \label{fig:r3d_all}
\end{figure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/gpf.png}
    \caption{Subfigure 1}
    \label{fig:sub1}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/rgpf.png}
    \caption{Subfigure 2}
    \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/linefit.png}
    \caption{Subfigure 3}
    \label{fig:sub3}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/ransac.png}
    \caption{Subfigure 4}
    \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/patchwork.png}
    \caption{Subfigure 5}
    \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/patchworkpp.png}
    \caption{Subfigure 6}
    \label{fig:sub6}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/groundgrid3d.png}
    \caption{Subfigure 7}
    \label{fig:sub7}
  \end{subfigure}
  \caption{Main figure caption with 8 subfigures}
  \label{fig:main1}
  \end{figure}  
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/input.png}
      \caption{Subfigure 1}
      \label{fig:sub1}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/gpf.png}
      \caption{Subfigure 2}
      \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/rgpf.png}
      \caption{Subfigure 3}
      \label{fig:sub3}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/linefit.png}
      \caption{Subfigure 4}
      \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/ransac.png}
      \caption{Subfigure 5}
      \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/patchwork.png}
      \caption{Subfigure 6}
      \label{fig:sub6}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/patchworkpp.png}
      \caption{Subfigure 7}
      \label{fig:sub7}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/botanic_garden/groundgrid3d.png}
    \caption{Subfigure 8}
    \label{fig:sub8}
  \end{subfigure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/input.png}
      \caption{Subfigure 1}
      \label{fig:sub1}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/gpf.png}
      \caption{Subfigure 2}
      \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/rgpf.png}
      \caption{Subfigure 3}
      \label{fig:sub3}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/linefit.png}
      \caption{Subfigure 4}
      \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/ransac.png}
      \caption{Subfigure 5}
      \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/patchwork.png}
      \caption{Subfigure 6}
      \label{fig:sub6}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/patchworkpp.png}
      \caption{Subfigure 7}
      \label{fig:sub7}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/groundgrid3d.png}
      \caption{Subfigure 8}
      \label{fig:sub8}
  \end{subfigure}
...
\begin{table}[h!]
  ...
  \hline
  GPF & 94.95\pm4.99 & 79.02\pm27.2 & 86.26 & 13 \\ 
  \hline
  RGPF & 59.2\pm11.56 & 96.57\pm1.83 & 73.40 & 18 \\ 
  \hline
  RANSAC & 87.52\pm14.63 & 93.35\pm11.38 & 90.84 & 64  \\ 
  \hline
  LineFit & 98.15\pm0.97 & 83.05\pm9.94 & 89.97 & 7 \\ 
  \hline
  Patchwork & 92.34\pm3.31 & 94.61\pm3.44 & 93.46 & 17 \\ 
  \hline
  Patchwork++ & 94.62\pm2.76 & 98.73\pm1.10 & 96.62 & 11  \\ 
  \hline
  GroundGrid3D & 94.77\pm4.02 & 90.66\pm5.93 & 92.67 & 179\\ 
  \hline
\end{tabular}%
  }
...
\begin{table}[h!]
  ...
  \hline
  GroundGrid3D & 93.81\pm4.42  & 85.45\pm6.42  & 89.44  & 80\\ 
  \hline
\end{tabular}%
  }
