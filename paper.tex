...
plane fitting based segmentation. \todo{TODO} How does CZH work in relation to this?
...
We test our solution on various available datasets with the same set of parameters.
...
\begin{table}[h!]
  ...
  \hline
  \textbf{neighborsIndexThreshold} & 1 & Number of neighbors analyzed for neighborhood analysis. \\
  \hline
...
\begin{figure}[h!]
  \centering
  % First row of 3 subfigures
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/gpf_00.png}
    \caption{Subfigure 1}
    \label{fig:sub1}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/groundgrid_00.png}
    \caption{Subfigure 2}
    \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/linefit_00.png}
    \caption{Subfigure 3}
    \label{fig:sub3}
  \end{subfigure}
  ...
  % Second row of 4 subfigures
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/patchwork_00.png}
    \caption{Subfigure 4}
    \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/patchworkpp_00.png}
    \caption{Subfigure 5}
    \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/ransac_00.png}
    \caption{Subfigure 6}
    \label{fig:sub6}
  \end{subfigure}
  ...
  % Third row of 2 subfigures
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/00_499/rgpf_00.png}
    \caption{Subfigure 7}
    \label{fig:sub7}
  \end{subfigure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g15401.png}
      \caption{Subfigure 1}
      \label{fig:sub1}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g30323.png}
      \caption{Subfigure 2}
      \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g37120.png}
      \caption{Subfigure 3}
      \label{fig:sub3}
  \end{subfigure}
  ...
  % Second row of 3 subfigures
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g44109.png}
      \caption{Subfigure 4}
      \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g49838.png}
      \caption{Subfigure 5}
      \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g70360.png}
      \caption{Subfigure 6}
      \label{fig:sub6}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/botanic_garden/g56365.png}
      \caption{Subfigure 7}
      \label{fig:sub7}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
    \centering
    \includegraphics[width=\textwidth]{figures/botanic_garden/g65445.png}
    \caption{Subfigure 8}
    \label{fig:sub8}
  \end{subfigure}
...
\begin{figure}[h!]
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g8810.png}
      \caption{Subfigure 1}
      \label{fig:sub1}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g128268.png}
      \caption{Subfigure 2}
      \label{fig:sub2}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g128273.png}
      \caption{Subfigure 3}
      \label{fig:sub3}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g128278.png}
      \caption{Subfigure 4}
      \label{fig:sub4}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g128283.png}
      \caption{Subfigure 5}
      \label{fig:sub5}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g137605.png}
      \caption{Subfigure 6}
      \label{fig:sub6}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g148660.png}
      \caption{Subfigure 7}
      \label{fig:sub7}
  \end{subfigure}
  \hspace{0.02\textwidth}
  \begin{subfigure}[b]{0.23\textwidth}
      \centering
      \includegraphics[width=\textwidth]{figures/urbanNav_10sec/g159265.png}
      \caption{Subfigure 8}
      \label{fig:sub8}
  \end{subfigure}
